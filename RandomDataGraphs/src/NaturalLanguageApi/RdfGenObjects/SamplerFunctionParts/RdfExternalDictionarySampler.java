...
/**
 * Class that represents a ExternalDictionarySampler in RDF format
 */
public class RdfExternalDictionarySampler extends RdfDictionarySampler {
     ...
     */
    public RdfExternalDictionarySampler(String type) {
        _type = type;
    }
    ...
    public String toRdfString(int tabOffset) {
        ...
        ctrDicSampler += RdfPrinter.printTabbedComposite(tabOffset, RdfGenTypes.RDF_GEN_PREFIX + RdfGenTypes.RES_RDF_TYPE_EXT_DIC_SAMPLER, lines);

...
/**
 * Class that represents a constant value that will be used repetition mode
 */
public class RdfRepeatConst extends RdfPatternRepeatMode {
     ...
     * @param constValue - The newly set const value
     */
    public RdfRepeatConst(int constValue) {
    ...
    public String toRdfString(int tabOffset) {
        ...
        lines.add(constVal);
        repeatConst += RdfPrinter.printTabbedComposite(tabOffset, RdfGenTypes.RDF_GEN_PREFIX + RdfGenTypes.RES_RDF_TYPE_REPEAT_CONST, lines);
        return repeatConst;
    }
}

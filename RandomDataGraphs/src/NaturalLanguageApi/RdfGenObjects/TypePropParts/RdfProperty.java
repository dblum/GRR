...
/**
 * Class that represents an rdf-type in RDF format
 */
public class RdfProperty extends RdfObject {
     ...
     */
    public RdfProperty(String type) {
        _type = type;
    }
    ...
    public String toRdfString(int tabOffset) {
        ...
        prop += RdfPrinter.printTabbedComposite(tabOffset, RdfGenTypes.RDF_GEN_PREFIX + RdfGenTypes.RES_RDF_TYPE_PROPERTY, lines);

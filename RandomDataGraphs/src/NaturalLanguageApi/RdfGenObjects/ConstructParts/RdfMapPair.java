...
/**
 * Class that represents a pair of node-id and attribute-name in RDF format
 */
public class RdfMapPair extends RdfObject {
     ...
     */
    public RdfMapPair(int id, String attributeName) {
        _id = id;
    ...
    public String toRdfString(int tabOffset) {
        ...
        mapPair += RdfPrinter.printTabbedComposite(tabOffset, RdfGenTypes.RDF_GEN_PREFIX + RdfGenTypes.RES_RDF_TYPE_MAP_PAIR, lines);

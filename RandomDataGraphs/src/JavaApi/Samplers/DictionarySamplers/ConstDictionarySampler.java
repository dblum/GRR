...
/**
 * A simple constant label sampler that always returns the same string value
 */
public class ConstDictionarySampler implements IDictionarySampler {
    ...
    /**
     * Constructor
     * Simple constructor that is set to not-initialized state
     * The instance must be initialized by init
     */
    public ConstDictionarySampler() {

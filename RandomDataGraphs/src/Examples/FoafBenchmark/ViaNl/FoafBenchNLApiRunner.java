...
package Examples.FoafBenchmark.ViaNl;
 ...
 *
 */
public class FoafBenchNLApiRunner {
    ...
    public static void main(String args[]) throws Exception {
        ...
        //for (int i = 0; i < 10; i++) {
            ...
            //String nlInputFile = INPUT_PATH + "FoafNLGenerator_" + index + ".txt";
            ...
            //  ---------------------- FOR LOGGING ONLY -----------------------------------------------------
            String[] types = new String[]{"foaf:Person", "foaf:Project"};
